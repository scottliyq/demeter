...
def backtest_spread_alpha(a, hedge_spread_split,hedge_spread_rate,alpha):
    ...
    notice = f"spread+alpha:{RUNNING_TIME} times, a:{decimal_a}, hedge_spread_split:{decimal_hedge_spread_split}, hedge_spread_rate:{decimal_hedge_spread_rate},alpa:{alpha},"
...
if __name__ == "__main__":
    ...
    # print(profit)
    # profit
    opt = optunity.maximize(backtest_spread_alpha,  num_evals=200,solver_name='particle swarm', a=[1.16, 1.25], hedge_spread_split=[2, 3],hedge_spread_rate=[0.7, 1],alpha=[0.008, 0.08])
